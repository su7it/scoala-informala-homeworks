...
public class Phaeton extends VW {
	private final static float FUEL_TANK_SIZE = 100f;
	private final static int NUMBER_OF_GEARS = 6;
	private final static float CONSUMTION_KM = 0.100f;
	private final static String FUEL_TYPE = "Diesel";

	public Phaeton(float availableFuel, String chasseNumber) {
